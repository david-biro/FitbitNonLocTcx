...
func main() {
	...
	authURL := getAuthURL(codeChallenge)
...
func getAuthURL(codeChallenge string) string {
	return fmt.Sprintf(
		...
		oauth2Config.ClientID, oauth2Config.RedirectURL, scopeStringBuilder(oauth2Config.Scopes), codeChallenge, "S256", generateRandomString())
}
